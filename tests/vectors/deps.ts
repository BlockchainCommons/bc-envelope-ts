...
export async function baselineDeps(): Promise<Deps> {
  const components: any =
    await import("../../../bc-components-ts/tests/baseline/components-baseline.mjs");
  const rand: any = await import("../../../bc-rand-ts/tests/baseline/rand-baseline.mjs");
  const sskr: any = await import("../../../bc-sskr-ts/tests/baseline/sskr-baseline.mjs");
  return {
    components,
    rand,
    sskr,
