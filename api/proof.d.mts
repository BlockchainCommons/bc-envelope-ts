...
/** `true` when `proof` has this envelope's digest and reveals every digest in `target`. */
export declare function confirmContainsSet(envelope: Envelope, target: Set<Digest>, proof: Envelope): boolean;

/** `true` when `proof` has this envelope's digest and reveals `target`. */
export declare function confirmContainsTarget(envelope: Envelope, target: Envelope, proof: Envelope): boolean;
...
/** A proof that this envelope contains every digest in `target`: everything else elided, or `undefined` when a digest is absent. */
export declare function proofContainsSet(envelope: Envelope, target: Set<Digest>): Envelope | undefined;

/** A proof that this envelope contains `target` (see `proofContainsSet`). */
export declare function proofContainsTarget(envelope: Envelope, target: Envelope): Envelope | undefined;
...
export declare namespace t {
    export { confirmContainsSet, confirmContainsTarget, proofContainsSet, proofContainsTarget };
}
