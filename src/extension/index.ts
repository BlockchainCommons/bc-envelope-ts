...
// Type system - IS_A is now imported from @blockchaincommons/known-values
// Import types module for side effects (prototype registration)
import "./types";
export { IS_A } from "@blockchaincommons/known-values";
...
export { SIGNED, NOTE } from "@blockchaincommons/known-values";

// Attachment support
export { Attachments } from "./attachment";
export { ATTACHMENT, VENDOR, CONFORMS_TO } from "@blockchaincommons/known-values";

// Edge support (BCR-2026-003)
export { Edges, type Edgeable } from "./edge";
export { EDGE, SOURCE, TARGET } from "@blockchaincommons/known-values";
