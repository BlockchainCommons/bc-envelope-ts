 ...
 */
export { SealedMessage as ComponentsSealedMessage } from "@blockchaincommons/components";

/**
 * Re-export Encrypter and Decrypter types for convenience.
 */
export type { Encrypter, Decrypter } from "@blockchaincommons/components";
 ...
 */
export { EncapsulationPublicKey as PublicKeyBase } from "@blockchaincommons/components";
 ...
 */
export { PrivateKeys as PrivateKeyBase } from "@blockchaincommons/components";
